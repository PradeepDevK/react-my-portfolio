...
export default function Project() {
    const config = {
        projects: [
            {
                image: websiteImage1,
                description: 'These are some of my projects. I have built these with React, MERN and vanilla CSS. Check them out.',
                link: '#'
            },
            {
                image: websiteImage2,
                    ...
                    <div className='relative'>
                        ...
                        <div className='project-desc'>
                            ...
                            <div className='flex justify-center'>
                                <a className='button' target='blank' href={project.link}>View Project</a>
                            </div>
                        </div>                        
                    </div>
                )}
